    ...
    <div>
      ...
      <div className="section-head">
        <span className="title">
          ...
          <a className="section-head-link" href="files/Transcript_Mason_Lancellotti.pdf" target="_blank" rel="noopener noreferrer" style={{ fontSize: "12px" }}>
  ...
  return (
    <footer className="colophon" style={{ textTransform: 'none', letterSpacing: '0', fontSize: '12px', fontFamily: 'var(--font-body)' }}>
      ...
      <span style={{ textAlign: 'right', display: 'flex', gap: '18px', justifyContent: 'flex-end', flexWrap: 'wrap' }}>
        ...
        <a href="files/Transcript_Mason_Lancellotti.pdf" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--ink-2)', textDecoration: 'none' }}>Transcript</a>
